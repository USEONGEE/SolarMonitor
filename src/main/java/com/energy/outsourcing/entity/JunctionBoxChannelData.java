...
public class JunctionBoxChannelData extends BaseTimeEntity {
    ...
    public static JunctionBoxChannelData fromDTO(JunctionBoxChannelDataDto dto, JunctionBoxChannel channel, LocalDateTime timestamp) {
        ...
        data.setPower(dto.getVoltage() * dto.getCurrent());
        return data;
    }
}
